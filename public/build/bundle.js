    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "cards svelte-41yodn");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-41yodn");
    			add_location(button, file$1, 224, 14, 5167);
    			attr_dev(div, "class", "fail svelte-41yodn");
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(embed, "class", "svelte-41yodn");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*o*/ 32 && div2_class_value !== (div2_class_value = "" + (null_to_empty(/*o*/ ctx[5]) + " svelte-41yodn"))) {
